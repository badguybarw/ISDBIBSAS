...
$APIKey = "16A3210A665C6816B1888F75EA5E4C04"; // Go get your API here: http://steamcommunity.com/dev/apikey

include ('includes/errorcheck.php'); //To see whether or not you have the right extension in your URL

$steamid64 = $_GET["STEAM_0:0:151381705"];
...
$steamid32 = "STEAM_0:$authserver:$authid";
	...
	//The music, very simply really. Perhaps in the future I will extend the music feature?
...
<body>
			...
			<!--Where the first picture is put in to display -->
				<div class="left-side">
					...
					<div class="middle-left-box">
						...
						<p class="middle-left-box-text">
							In order for you to establish a full character Please learn how to RP first. Look for guides on the internet.
						</p>
						
						<p class="middle-left-box-text">
							The server was made in the start of 2014 and was originally hosted on the Owners PC, Since then it has grown into a vast community.
						</p>
				...
				<div class="middle-box">
					...
					<table class="server-info-table" style="width:100%">
						...
						<td style="width:85%">
							Do not annoy or bother admins if they are trying to RP.
						</td>
					</table>
						<hr class="blue-line2">
					<table class="server-info-table" style="width:100%">
	...
	document.getElementById("The Purge").innerHTML = gamemode;
	document.getElementById("FTP THE PURGE").innerHTML = servername;
	document.getElementById("rp_downtown_v4c_v2").innerHTML = mapname;
	}
